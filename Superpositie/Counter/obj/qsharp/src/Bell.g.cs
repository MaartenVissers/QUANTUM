...
#line 10 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
            var current = M.Apply(q1);
#line 12 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
            if ((desired != current))
            {
#line 13 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
...
#line 20 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
            var numOnes = 0L;
#line hidden
            {
#line 22 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                var qubit = Allocate.Apply();
#line 23 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                foreach (var test in new Range(1L, count))
#line hidden
                {
#line 24 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                    Set.Apply((initial, qubit));
#line 29 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                    MicrosoftQuantumPrimitiveH.Apply(qubit);
#line 30 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                    var res = M.Apply(qubit);
#line 32 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                    if ((res == Result.One))
                    {
#line 33 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                        numOnes = (numOnes + 1L);
                    }
                }

#line 38 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
                Set.Apply((Result.Zero, qubit));
#line hidden
                Release.Apply(qubit);
            }

#line 41 "E:\\Maarten\\Documents\\School\\Derde Jaar\\TIConference\\Counter\\Counter\\Bell.qs"
